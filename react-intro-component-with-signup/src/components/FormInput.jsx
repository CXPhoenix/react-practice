...
function FormInput({inputName, inputType, isSubmit, isEmail}) {
    ...
    return (
        <div className="text-center relative">
            <input className="w-11/12 border-[1px] border-[#b9b6d3] focus:border-[#3e3c49] rounded-lg p-3 pl-6" type={inputType} placeholder={inputName} onChange={inputOnChange} />
